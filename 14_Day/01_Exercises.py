#Diferencia entre: mapa, filtro y reducción.
...
#Diferencia entre: superior, cierre y decorador.
...
#Defina una función de llamada antes de map, filter o reduce
numeros = [1,2,3,4,5]
def cuadrado(x):
    return x ** 2
...
#Utilice el bucle for para imprimir cada país 
...
#Utilice for para imprimir cada nombre 
for name in names:
    print(name)

#Utilice for para imprimir cada número 
