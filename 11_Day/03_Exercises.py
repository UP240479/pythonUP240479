#Escriba una función llamada is_prime
def is_prime(n):
    if n <= 1:
        return False
...
#Escriba una función que verifique elementos de la lista
...
#Escriba una función que verifique si todos los elementos de la lista 
